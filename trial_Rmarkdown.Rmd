...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'trial_Rmarkdown.html'))})
---
...
Then going to github to merge your pull request. 

Refresh the webpage, then you are done!
